...
data = [args.model, 'Densenet', args.depth, args.dataset, num_parameters, args.percent, 1-num_parameters/total_parameters, 1-flops/total_flops, checkpoint['best_prec1'].item(), pruned_acc.item()]
